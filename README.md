...
# 📖 [Jest-Testing-Practice] <a name="Jest-Testing-Practice"></a>

**[Jest-Testing-Practice]** is a simple a simple web page that sisplays a list of To Do tasks. It is built using webpack and served by a webpack dev server.
...
## 🚀 Live Demo <a name="live-demo">Live Demo</a>

Coming Soon!

## 💻 Getting Started <a name="getting-started"></a>

Creating your first "Jest-Testing-Practice" project
...
```sh
  cd my-folder
  git clone[(https://github.com/joyapisi/Jest-Testing-Practice.git)]
```
## Understand Set Up Requirements
Since this code is using webpack, you will run `npm start` in your terminal to view the live version in the browser instead of using `open with live server.` 
...
### Define Jest
<a href="https://jestjs.io/">Jest</a> is a delightful JavaScript Testing Framework with a focus on simplicity. It works with projects using: Babel, TypeScript, Node, React, Angular, Vue and more!
...
# Install webpack, Jest and linters <a name="install"></a>
...
## Install Jest <a name="Jest-installation"></a>
To install Jest in your local project, run `npm install --save-dev jest` in your terminal
To install Jest globally, run `npm install jest --global` in a terminal outside your local project
Use <a href="https://jestjs.io/docs/getting-started">this guide</a> to do some testing practice with Jest
...
<p self-align="right">(<a href="#readme-top">back to top</a>)</p>
